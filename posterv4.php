    ...
    ?>
        <section class="section1">
            ...
            <div>
                ...
                <a class="a1" href="Posters.html">Poster /</a>
                <div style="margin-top: -15px;">
                    <p>Poster v4</p>
                </div>
                </div>
                
                <a class="a2"href="Posters.html">Poster</a>
                <p style= "font-size: xx-large; margin-left:20px ;">Poster V4</p>
        ...
        <script>
                ...
                <div class="relie">
                    <p>Categories</p>
                    <div class="lien"><a class="a2"href="">Poster</a></div>
        ...
        <section class="section2">
            <div class=" lien1">
                <a class="a3" href="posterv4.html">Description</a>
        ...
        <section class="section3">
            ...
            <div class="Postercard1">
                <div>
                    <a href="posterv3.html"><img src="img/imag7.png" alt=""></a>                    
                ...
                <div>
                    <a href="posterv2.html"><img src="PosteV2.jpg" alt=""></a>                    
                    <p style="color:gray; font-size:large;margin-left:20px ;">Poster</p>
                ...
                <div>
                    <a href="posterv1.html"><img src="PosteV1.jpg" alt=""></a>
                    <p style="color: gray; font-size:large;margin-left:20px ;">Poster</p>
