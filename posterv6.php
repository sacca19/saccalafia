 ...
 <?php 
    ...
    ?>
        ...
        <section class="section3">
            <div class=" lien1">
                <a class="a3" href="posterv6.html">Description</a>
            ...
            <div class="Postercard1">
                <div>
                    <a href="posterv5.html"><img src="PosteV1.jpg" alt=""></a>                    
                ...
                <div>
                    <a href="posterv4.html"><img src="PosteV1.jpg" alt=""></a>                    
                    <p style="color:gray; font-size:large;margin-left:20px ;">Poster</p>
                ...
                <div>
                    <a href="posterv4.html"><img src="img/img"></a>                    
                    <p style="color: gray; font-size:large;margin-left:20px ;">Poster</p>
