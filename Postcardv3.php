...
<header>
    ...
    <section class="section2">
        <div class=" lien1">
            <a class="a3" href="Postcardv3.php">Description</a>
    ...
    <section class="section3">
        ...
        <div class="Postercard1">
            <div>
                <a href="Postcardv6.php"><img src="img/imag5.png" alt=""></a>
            ...
            <div>
                <a href="Postcardv2.php"><img src="img/imag4.png" alt=""></a>
                <p style="color:gray; font-size:large;margin-left:20px ;">Postcards</p>
            ...
            <div>
                <a href="Postcardv4.php"><img src="img/image6.png" alt=""></a>
                <p style="color: gray; font-size:large;margin-left:20px ;">Postcards</p>
