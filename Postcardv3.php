...
<body>
    ...
    <section class="section1">
        <div class="contenu1">
            <img class="image" src="img/imag3.png" alt="">
            <div>
                <div class="menu1">
                ...
                <p style="font-size: xx-large; margin-left:20px ;">Postcards V3</p>
    ...
    <section class="section2">
        <div class=" lien1">
            <a class="a3" href="Postcardv3.html">Description</a>
    ...
    <section class="section3">
        ...
        <div class="Postercard1">
            <div>
                <a href="Postcardv6.html"><img src="img/imag5.png" alt=""></a>
            ...
            <div>
                <a href="Postcardv2.html"><img src="img/imag4.png" alt=""></a>
                <p style="color:gray; font-size:large;margin-left:20px ;">Postcards</p>
            ...
            <div>
                <a href="Postcardv4.html"><img src="img/image6.png" alt=""></a>
                <p style="color: gray; font-size:large;margin-left:20px ;">Postcards</p>
