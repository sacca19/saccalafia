...
<body>
    ...
    <section class="section1">
        <div class="contenu1">
            <img class="image" src="assets/img/imag3.png" alt="">
            <div>
                <div class="menu1">
    ...
    <section class="section3">
        ...
        <div class="Postercard1">
            <div>
                <a href="Postcardv6.php"><img src="assets/img/imag5.png" alt=""></a>
            ...
            <div>
                <a href="Postcardv4.php"><img src="assets/img/image6.png" alt=""></a>
                <p style="color: gray; font-size:large;margin-left:20px ;">Postcards</p>
