...
<header>
        ...
        <section class="section1">
            ...
            <div>
                ...
                <p style= "font-size: xx-large; margin-left:20px ;">Posters V1</p>
        ...
        <section class="section3">
            ...
            <div class="Postercard1">
                <div>
                    <a href="posterv1.php"><img src="img/img" alt=""></a>                    
                ...
                <div>
                    <a href="posterv1.php"><img src="img/img3.png" alt=""></a>                    
                    <p style="color:gray; font-size:large;margin-left:20px ;">Poster</p>
                ...
                <div>
                    <a href="posterv1.php"><img src="img/imag7.png" alt=""></a>                     
                    <p style="color: gray; font-size:large;margin-left:20px ;">Poster</p>
