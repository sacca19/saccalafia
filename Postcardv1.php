...
<body>
        ...
        <div class="contenu1">
            ...
            <div>
                ...
                <div class="card">
                    ...
                    <div class="relie">
                        <p>Categories</p>
                        <div class="lien"><a class="a2" href="Postcards.html">Postcards</a></div>
    ...
    <section class="section2">
        <div class=" lien1">
            <a class="a3" href="Postcardv1.html">Description</a>
    ...
    <section class="section3">
        ...
        <div class="Postercard1">
            <div>
                <a href="Postcardv1.html"><img class="img" src="img/imag.png" alt=""></a>
            ...
            <div>
                <a href="Postcardv2.html"><img class="img" src="img/img3.png" alt=""></a>
                <p style="color:gray; font-size:large;margin-left:20px ;">Postcards</p>
            ...
            <div>
                <a href="Postcardv3.html"><img class="img" src="img/imag3.png" alt=""></a>
                <p style="color: gray; font-size:large;margin-left:20px ;">Postcards</p>
