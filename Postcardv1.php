...
<header>
    ...
    <section class="section3">
        ...
        <div class="Postercard1">
            <div>
                <a href="Postcardv1.php"><img class="img" src="img/imag.png" alt=""></a>
            ...
            <div>
                <a href="Postcardv2.php"><img class="img" src="img/img3.png" alt=""></a>
                <p style="color:gray; font-size:large;margin-left:20px ;">Postcards</p>
            ...
            <div>
                <a href="Postcardv3.php"><img class="img" src="img/imag3.png" alt=""></a>
                <p style="color: gray; font-size:large;margin-left:20px ;">Postcards</p>
